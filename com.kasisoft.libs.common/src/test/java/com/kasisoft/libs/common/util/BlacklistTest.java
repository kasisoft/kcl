...
public class BlacklistTest {
  ...
  public void setUp() {
    ...
    expected    = IoFunctions.readTextFully( MiscFunctions.getResource( "/blacklist/text_base.txt" ) );
    assertNotNull( expected );
    
    csblacklist = new Blacklist( "/blacklist/blacklist_01.txt" );
    ciblacklist = new Blacklist( "/blacklist/blacklist_02.txt" );
  ...
  public void commentPrefix() {
    ...
    prefixed.load( "/blacklist/blacklist_03.txt" );
  ...
  public void cleanTextCaseSensitive() {
    String text = IoFunctions.readTextFully( MiscFunctions.getResource( "/blacklist/text_01.txt" ) );
    assertNotNull( text );
  ...
  public void cleanTextCaseInsensitive() {
    String text = IoFunctions.readTextFully( MiscFunctions.getResource( "/blacklist/text_02.txt" ) );
    assertNotNull( text );
    assertFalse( text.equals( expected ) );
