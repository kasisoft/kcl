...
public class SwingFunctions {
  ...
  /**
   * Restores the bounds of a component. The restauration only happens if there were settings. This function is 
   * typically called when a component will be initialised.
   * 
   ...
   */
  public static final void restoreBounds( String property, Component component ) {
