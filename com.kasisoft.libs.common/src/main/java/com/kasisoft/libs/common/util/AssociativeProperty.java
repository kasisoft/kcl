...
public class AssociativeProperty<T> {
   ...
   */
  public Map<String,T> get( ExtProperties props ) {
   ...
   * @param association   The association used to access a specific pair. Neither <code>null</code> nor empty.
   *                      
   * @return   The associated property value. Maybe <code>null</code>.
   */
  public T get( ExtProperties props, String association ) {
   ...
   * @return   The associated property value. Maybe <code>null</code>.
   */
  public T get( ExtProperties props, String association, T defvalue ) {
   ...
   * @throws FailureException if the property value cannot be converted properly and the generation of failures is enabled.
   */
  public void set( ExtProperties props, Map<String,T> values ) {
   ...
   * 
   * @param props         The Properties which need to be altered. Not <code>null</code>.
   * @param association   The associative key used to store the property. Neither <code>null</code> nor empty.
   * @param value         The value which has to be stored. Maybe <code>null</code>.
   * 
   * @throws FailureException if the property value cannot be converted properly and the generation of failures is enabled.
   */
  public void set( ExtProperties props, String association, T value ) {
   ...
   * 
   * @param props         The Properties which need to be altered. Not <code>null</code>.
   * @param association   The name of the association key which value has to be removed. Neither <code>null</code> nor empty.
   */
  public void remove( ExtProperties props, String association ) {
