...
public class BooleanAdapterTest {
    ...
    public static Stream<Arguments> data_decode() {
        return Stream.of(Arguments.of(null, null), Arguments.of("true", Boolean.TRUE), Arguments.of("false", Boolean.FALSE), Arguments.of("ja", Boolean.TRUE), Arguments.of("nein", Boolean.FALSE), Arguments.of("an", Boolean.TRUE), Arguments.of("ein", Boolean.TRUE), Arguments.of("aus", Boolean.FALSE), Arguments.of("on", Boolean.TRUE), Arguments.of("off", Boolean.FALSE), Arguments.of("0", Boolean.FALSE), Arguments.of("1", Boolean.TRUE), Arguments.of("-1", Boolean.TRUE), Arguments.of("", Boolean.FALSE));
    }
    ...
    public static Stream<Arguments> data_encode() {
        return Stream.of(Arguments.of(null, null), Arguments.of(Boolean.TRUE, "true"), Arguments.of(Boolean.FALSE, "false"));
    }
