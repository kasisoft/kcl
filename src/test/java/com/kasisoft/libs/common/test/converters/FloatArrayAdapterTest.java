...
public class FloatArrayAdapterTest {
    ...
    public static Stream<Arguments> data_decode() {
        return Stream.of(Arguments.of(null, null), Arguments.of("3.1", new float[] {
            3.1f}), Arguments.of("3.2,+INF", new float[] {3.2f,
                Float.POSITIVE_INFINITY}), Arguments.of("4.2,MAX", new float[] {4.2f,
                    Float.MAX_VALUE}), Arguments.of("-1.2,MIN", new float[] {-1.2f,
                        Float.MIN_VALUE}), Arguments.of("9.1,2.1", new float[] {9.1f, 2.1f}));
    }
    ...
    public static Stream<Arguments> data_encode() {
        return Stream.of(Arguments.of(null, null), Arguments.of(new float[] {7.9f,
            Float.MAX_VALUE}, "7.9,MAX"), Arguments.of(new float[] {-3.1f, Float.NaN}, "-3.1,NaN"));
    }
