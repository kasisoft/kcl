...
public class LongArrayAdapterTest {
    ...
    public static Stream<Arguments> data_decode() {
        return Stream.of(Arguments.of(null, null), Arguments.of("", new long[0]), Arguments.of("31", new long[] {
            31}), Arguments.of("-47,12", new long[] {-47, 12}));
    }
    ...
    public static Stream<Arguments> data_encode() {
        return Stream.of(Arguments.of(null, null), Arguments.of(new long[0], ""), Arguments.of(new long[] {79,
            1201}, "79,1201"), Arguments.of(new long[] {-31, -128}, "-31,-128"));
    }
