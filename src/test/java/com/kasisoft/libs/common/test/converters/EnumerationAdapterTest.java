...
public class EnumerationAdapterTest {
    ...
    public static Stream<Arguments> data_decode_ci() {
        return Stream.of(Arguments.of(null, null), Arguments.of("gandalf", LordOfTheRings.Gandalf), Arguments.of("bilbo", LordOfTheRings.Bilbo), Arguments.of("boromir", LordOfTheRings.Boromir));
    }
    ...
    public static Stream<Arguments> data_encode_ci() {
        return Stream.of(Arguments.of(null, null), Arguments.of(LordOfTheRings.Gandalf, "Gandalf"), Arguments.of(LordOfTheRings.Bilbo, "Bilbo"), Arguments.of(LordOfTheRings.Boromir, "Boromir"));
    }
