...
public class DoubleArrayAdapterTest {
    ...
    public static Stream<Arguments> data_decode() {
        return Stream.of(Arguments.of(null, null), Arguments.of("3.1", new double[] {
            3.1}), Arguments.of("3.2,+INF", new double[] {3.2,
                Double.POSITIVE_INFINITY}), Arguments.of("4.2,MAX", new double[] {4.2,
                    Double.MAX_VALUE}), Arguments.of("-1.2,MIN", new double[] {-1.2,
                        Double.MIN_VALUE}), Arguments.of("9.1,2.1", new double[] {9.1, 2.1}));
    }
    ...
    public static Stream<Arguments> data_encode() {
        return Stream.of(Arguments.of(null, null), Arguments.of(new double[] {7.9,
            Double.MAX_VALUE}, "7.9,MAX"), Arguments.of(new double[] {-3.1, Double.NaN}, "-3.1,NaN"));
    }
