...
public class ColorAdapterTest {
    ...
    public static Stream<Arguments> data_decode() {
        return Stream.of(Arguments.of(null, null), Arguments.of("yellow", Color.yellow), Arguments.of("blue", Color.BLUE), Arguments.of("#ffffff00", Color.yellow), Arguments.of("#ff0000ff", Color.BLUE), Arguments.of("#ffff00", Color.yellow), Arguments.of("#0000ff", Color.BLUE), Arguments.of("rgb(255,255,0)", Color.yellow), Arguments.of("rgb(0,0,255)", Color.BLUE));
    }
    ...
    public static Stream<Arguments> data_invalidDecode() {
        return Arrays.asList("12:-13:42", "0:", "a:b", "#", "#zzzzzz", "rgb", "rgb(", "rgb)", "rgb()", "rgb(a,b,c)").stream().map(Arguments::of);
    }
    ...
    public static Stream<Arguments> data_encode() {
        return Stream.of(Arguments.of(null, null), Arguments.of(Color.yellow, "#ffffff00"), Arguments.of(Color.BLUE, "#ff0000ff"));
    }
