...
public class URLAdapterTest {
    ...
    public static Stream<Arguments> data_decode() throws Exception {
        return Stream.of(Arguments.of(null, null), Arguments.of("http://www.amiga-news.de", URI.create("http://www.amiga-news.de").toURL()));
    }
    ...
    public static Stream<Arguments> data_encode() throws Exception {
        return Stream.of(Arguments.of(null, null), Arguments.of(URI.create("http://www.amiga-news.de").toURL(), "http://www.amiga-news.de"));
    }
