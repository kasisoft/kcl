...
public class DigestTest {
  ...
  public static Stream<Arguments> data_digest() {
    return Stream.of(
      ...
      Arguments.of("This is my test phrase", Digest.MD5   ),
      Arguments.of("This is my test phrase", Digest.SHA1  ),
      Arguments.of("This is my test phrase", Digest.SHA256),
      Arguments.of("This is my test phrase", Digest.SHA384),
      Arguments.of("This is my test phrase", Digest.SHA512)
    );
  }
  ...
  public static Stream<Arguments> data_digestToString() {
    return Stream.of(
      ...
      Arguments.of("This is my test phrase", Digest.MD5   , "76a2d4204bcd9ea5aac40ebf833f7345"),
      Arguments.of("This is my test phrase", Digest.SHA1  , "bc73f7c09da0c9791cb38e93a4d3bf22e53a467d"),
      Arguments.of("This is my test phrase", Digest.SHA256, "6d73554fcfa28065a41eb49038049f848b91efc6af26ab0035e709bb4bf63cc7"),
