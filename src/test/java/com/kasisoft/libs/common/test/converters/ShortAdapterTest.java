...
public class ShortAdapterTest {
    ...
    public static Stream<Arguments> data_decode() {
        return Stream.of(Arguments.of(null, null), Arguments.of("0", Short.valueOf((short) 0)), Arguments.of("13", Short.valueOf((short) 13)), Arguments.of("-23", Short.valueOf((short) -23)));
    }
    ...
    public static Stream<Arguments> data_encode() {
        return Stream.of(Arguments.of(null, null), Arguments.of(Short.valueOf((short) 0), "0"), Arguments.of(Short.valueOf((short) 13), "13"), Arguments.of(Short.valueOf((short) -23), "-23"));
    }
