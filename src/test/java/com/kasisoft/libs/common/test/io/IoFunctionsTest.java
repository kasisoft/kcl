...
public class IoFunctionsTest {
    ...
    private static final String        CONTENT_FOR_STREAMS = "" + "Dies ist mein Text mit Umlauten.\n"
        + "Größer wird der Kram hier aber auch nicht.\n" + "Auf dieser Zeile liest man nur Quark.\n";

    private static final String        CONTENT_FOR_READERS = "" + "Kleener Text wirkt abgehezt.\n"
        + "Drum isses schön sich auszuruhen.\n" + "Huppifluppi ist ein ß.\n";

    private static final String        CONTENT_HTTP_XSD    = "" + "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n"
    ...
    public static Stream<Arguments> data_compileFileSystemPattern() {
        return Stream.of(Arguments.of("*", "([^/]+)"), Arguments.of("**", "(.+)"), Arguments.of("dir/**", "\\Qdir/\\E(.+)"), Arguments.of("dir/*", "\\Qdir/\\E([^/]+)"), Arguments.of("dir/*/subdir", "\\Qdir/\\E([^/]+)\\Q/subdir\\E"));
    }
    ...
    public static Stream<Arguments> data_newOutputStream() throws Exception {
        ...
        return Stream.of(Arguments.of(IoFunctions.IO_PATH, file1), Arguments.of(IoFunctions.IO_FILE, file2.toFile()), Arguments.of(IoFunctions.IO_URI, file3.toUri()));
    }
    ...
    public static Stream<Arguments> data_newWriter() throws Exception {
        ...
        return Stream.of(Arguments.of(IoFunctions.IO_PATH, file1, Encoding.ISO88591), Arguments.of(IoFunctions.IO_PATH, file2, Encoding.UTF8), Arguments.of(IoFunctions.IO_FILE, file3.toFile(), Encoding.ISO88591), Arguments.of(IoFunctions.IO_FILE, file4.toFile(), Encoding.UTF8), Arguments.of(IoFunctions.IO_URI, file5.toUri(), Encoding.ISO88591), Arguments.of(IoFunctions.IO_URI, file6.toUri(), Encoding.UTF8));
    }
    ...
    public <T> void forOutputStream__Error(IoSupport<T> ioSupport, T destination) throws Exception {
        assertThrows(KclException.class, () -> {
            ioSupport.forOutputStream(destination, $ -> {
    ...
    public <T> void forInputStream__Error(IoSupport<T> ioSupport, T source) throws Exception {
        assertThrows(KclException.class, () -> {
            ioSupport.forInputStream(source, $ -> {
                throw new KclException("error");
            });
        });
    }
    ...
    public static Stream<Arguments> data_forWriterDo__WithEncoding() throws Exception {
        ...
        return Stream.of(Arguments.of(IoFunctions.IO_PATH, file1, Encoding.UTF8), Arguments.of(IoFunctions.IO_PATH, file2, Encoding.ISO88591), Arguments.of(IoFunctions.IO_FILE, file3.toFile(), Encoding.UTF8), Arguments.of(IoFunctions.IO_FILE, file4.toFile(), Encoding.ISO88591), Arguments.of(IoFunctions.IO_URI, file5.toUri(), Encoding.UTF8), Arguments.of(IoFunctions.IO_URI, file6.toUri(), Encoding.ISO88591));
    }
    ...
    public static Stream<Arguments> data_forWriter__WithEncoding() throws Exception {
        ...
        return Stream.of(Arguments.of(IoFunctions.IO_PATH, file1, Encoding.UTF8), Arguments.of(IoFunctions.IO_FILE, file2.toFile(), Encoding.ISO88591), Arguments.of(IoFunctions.IO_URI, file3.toUri(), Encoding.UTF8), Arguments.of(IoFunctions.IO_PATH, file4, Encoding.ISO88591), Arguments.of(IoFunctions.IO_FILE, file5.toFile(), Encoding.UTF8), Arguments.of(IoFunctions.IO_URI, file6.toUri(), Encoding.ISO88591));
    }
    ...
    public static Stream<Arguments> data_loadBytes() throws Exception {
        ...
        return Stream.of(Arguments.of(IoFunctions.IO_PATH, httpXsd), Arguments.of(IoFunctions.IO_FILE, httpXsd.toFile()), Arguments.of(IoFunctions.IO_URI, httpXsd.toUri()), Arguments.of(IoFunctions.IO_URL, httpXsd.toFile().toURL()));
    }
