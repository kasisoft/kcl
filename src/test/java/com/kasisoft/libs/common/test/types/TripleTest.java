...
public class TripleTest {
    ...
    public static Stream<Arguments> data_processTriples() {
        return Stream.of(Arguments.of(new Triple<String, String, Boolean>("A", "mid0", true), "A", "mid0", true), Arguments.of(new Triple<String, String, Boolean>("A", "mid1", false), "A", "mid1", false), Arguments.of(new Triple<String, String, Boolean>("B", "mid2", true), "B", "mid2", true));
    }
