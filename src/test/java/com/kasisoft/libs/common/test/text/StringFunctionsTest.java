...
public class StringFunctionsTest {
    ...
    public static Stream<Arguments> data_regionReplaceFunction() {
        ...
        return Stream.of(Arguments.of("this is // my text // without a section // dodo //", replacement, "this is changed text without a section dodo text"), Arguments.of("this is // // my text // without a section // dodo //", replacement, "this is  my text  dodo //"), Arguments.of("this is // // my text // without a section // dodo // //", replacement, "this is  my text  dodo "));
    }
