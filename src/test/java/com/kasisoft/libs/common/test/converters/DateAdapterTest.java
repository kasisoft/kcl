...
public class DateAdapterTest {
    ...
    public static Stream<Arguments> data_decode() {
        return Stream.of(Arguments.of(null, null), Arguments.of("12.04.1987", new Date(87, 3, 12)), Arguments.of("03.07.1964", new Date(64, 6, 3)));
    }
    ...
    public static Stream<Arguments> data_encode() {
        return Stream.of(Arguments.of(null, null), Arguments.of(new Date(87, 3, 12), "12.04.1987"), Arguments.of(new Date(64, 6, 3), "03.07.1964"));
    }
