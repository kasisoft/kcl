...
public class StringFBufferTest {
  ...
  public void serialization() throws Exception {
    ...
    assertNotNull(read);
    assertTrue(StringFBuffer.class.isAssignableFrom(read.getClass()));
  ...
  @ParameterizedTest
  @MethodSource("data_buffers")
  public void trimLeading__WithSpecifiedChars(StringFBuffer buffer) {
    buffer.appendF("\r\n   My test is this: %s ! Not 0x%02x !", "Hello World", Integer.valueOf(17));
    buffer.trimLeading("\r\n ");
    assertThat(buffer.toString(), is("My test is this: Hello World ! Not 0x11 !"));
  }
  ...
  @ParameterizedTest
  @MethodSource("data_buffers")
  public void trimTrailing__WithSpecifiedChars(StringFBuffer buffer) {
    buffer.appendF("My test is this: %s ! Not 0x%02x !\r\n   ", "Hello World", Integer.valueOf(17));
    buffer.trimTrailing("\r\n ");
    assertThat(buffer.toString(), is("My test is this: Hello World ! Not 0x11 !"));
  }
  ...
  @ParameterizedTest
  @MethodSource("data_buffers")
  public void trim__WithSpecifiedChars(StringFBuffer buffer) {
    buffer.appendF("\r\n   My test is this: %s ! Not 0x%02x !\r\n   ", "Hello World", Integer.valueOf(17));
    buffer.trim("\r\n ", null);
    assertThat(buffer.toString(), is("My test is this: Hello World ! Not 0x11 !"));
  }
  ...
  @ParameterizedTest
  @MethodSource("data_buffers")
  public void trim__WithSpecifiedChars_Left(StringFBuffer buffer) {
    buffer.appendF("\r\n   My test is this: %s ! Not 0x%02x !\r\n   ", "Hello World", Integer.valueOf(17));
    buffer.trim("\r\n ", true);
    assertThat(buffer.toString(), is("My test is this: Hello World ! Not 0x11 !\r\n   "));
  }
  ...
  @ParameterizedTest
  @MethodSource("data_buffers")
  public void trim__WithSpecifiedChars_Right(StringFBuffer buffer) {
    buffer.appendF("\r\n   My test is this: %s ! Not 0x%02x !\r\n   ", "Hello World", Integer.valueOf(17));
    buffer.trim("\r\n ", false);
  ...
  public void regionReplaceSimple(StringFBuffer buffer, String replacement, String expected) {
  ...
  public void regionReplaceFunction(StringFBuffer buffer, Function<String, CharSequence> replacement, String expected) {
    assertThat(buffer.replaceRegions("//", replacement).toString(), is(expected));
  }
  ...
  private static StringFBuffer create(String input) {
    return new StringFBuffer(input);
  }

  private static StringFBuffer create() {
    return new StringFBuffer();
  }
  
  private static StringFBuffer create(int capacity) {
