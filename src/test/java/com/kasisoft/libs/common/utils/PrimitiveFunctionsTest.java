...
public class PrimitiveFunctionsTest {
  ...
  public void compare__char() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_CHARS, Empty.NO_CHARS, 0));
    assertTrue(PrimitiveFunctions.compare(new char[] {'a'}, new char[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new char[] {'a', 'z'}, new char[] {'a', 'z'}, 0));
    assertFalse(PrimitiveFunctions.compare(new char[] {'a', 'z'}, new char[] {'a', 'y'}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_CHARS, new char[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new char[] {'a'}, Empty.NO_CHARS, 0));
  ...
  public void find__char() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_CHARS, 'a', 0), is(-1));
    assertThat(PrimitiveFunctions.find(new char[] {'a'}, 'a', 0), is(0));
    assertThat(PrimitiveFunctions.find(new char[] {'a', 'z'}, 'z', 0), is(1));
  ...
  public void indexOf__char() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_CHARS, new char[] {'a'}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new char[] {'a'}, new char[] {'a'}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new char[] {'a', 'z'}, new char[] {'z'}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new char[] {'a', 'z', 'l', 'f'}, new char[] {'z', 'l'}, 0), is(1));
  ...
  public void compare__byte() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_BYTES, Empty.NO_BYTES, 0));
    assertTrue(PrimitiveFunctions.compare(new byte[] {'a'}, new byte[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new byte[] {'a', 'z'}, new byte[] {'a', 'z'}, 0));
    assertFalse(PrimitiveFunctions.compare(new byte[] {'a', 'z'}, new byte[] {'a', 'y'}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_BYTES, new byte[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new byte[] {'a'}, Empty.NO_BYTES, 0));
  ...
  public void find__byte() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_BYTES, (byte) 'a', 0), is(-1));
    assertThat(PrimitiveFunctions.find(new byte[] {(byte) 'a'}, (byte) 'a', 0), is(0));
    assertThat(PrimitiveFunctions.find(new byte[] {(byte) 'a', (byte) 'z'}, (byte) 'z', 0), is(1));
  ...
  public void indexOf__byte() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_BYTES, new byte[] {'a'}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new byte[] {'a'}, new byte[] {'a'}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new byte[] {'a', 'z'}, new byte[] {'z'}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new byte[] {'a', 'z', 'l', 'f'}, new byte[] {'z', 'l'}, 0), is(1));
  ...
  public void compare__short() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_SHORTS, Empty.NO_SHORTS, 0));
    assertTrue(PrimitiveFunctions.compare(new short[] {'a'}, new short[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new short[] {'a', 'z'}, new short[] {'a', 'z'}, 0));
    assertFalse(PrimitiveFunctions.compare(new short[] {'a', 'z'}, new short[] {'a', 'y'}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_SHORTS, new short[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new short[] {'a'}, Empty.NO_SHORTS, 0));
  ...
  public void find__short() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_SHORTS, (short) 'a', 0), is(-1));
    assertThat(PrimitiveFunctions.find(new short[] {(short) 'a'}, (short) 'a', 0), is(0));
    assertThat(PrimitiveFunctions.find(new short[] {(short) 'a', (short) 'z'}, (short) 'z', 0), is(1));
  ...
  public void indexOf__short() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_SHORTS, new short[] {'a'}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new short[] {'a'}, new short[] {'a'}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new short[] {'a', 'z'}, new short[] {'z'}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new short[] {'a', 'z', 'l', 'f'}, new short[] {'z', 'l'}, 0), is(1));
  ...
  public void compare__int() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_INTS, Empty.NO_INTS, 0));
    assertTrue(PrimitiveFunctions.compare(new int[] {'a'}, new int[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new int[] {'a', 'z'}, new int[] {'a', 'z'}, 0));
    assertFalse(PrimitiveFunctions.compare(new int[] {'a', 'z'}, new int[] {'a', 'y'}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_INTS, new int[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new int[] {'a'}, Empty.NO_INTS, 0));
  ...
  public void find__int() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_INTS, 'a', 0), is(-1));
    assertThat(PrimitiveFunctions.find(new int[] {'a'}, 'a', 0), is(0));
    assertThat(PrimitiveFunctions.find(new int[] {'a', 'z'}, 'z', 0), is(1));
  ...
  public void indexOf__int() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_INTS, new int[] {'a'}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new int[] {'a'}, new int[] {'a'}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new int[] {'a', 'z'}, new int[] {'z'}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new int[] {'a', 'z', 'l', 'f'}, new int[] {'z', 'l'}, 0), is(1));
  ...
  public void compare__long() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_LONGS, Empty.NO_LONGS, 0));
    assertTrue(PrimitiveFunctions.compare(new long[] {'a'}, new long[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new long[] {'a', 'z'}, new long[] {'a', 'z'}, 0));
    assertFalse(PrimitiveFunctions.compare(new long[] {'a', 'z'}, new long[] {'a', 'y'}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_LONGS, new long[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new long[] {'a'}, Empty.NO_LONGS, 0));
  ...
  public void find__long() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_LONGS, 'a', 0), is(-1));
    assertThat(PrimitiveFunctions.find(new long[] {'a'}, 'a', 0), is(0));
    assertThat(PrimitiveFunctions.find(new long[] {'a', 'z'}, 'z', 0), is(1));
  ...
  public void indexOf__long() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_LONGS, new long[] {'a'}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new long[] {'a'}, new long[] {'a'}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new long[] {'a', 'z'}, new long[] {'z'}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new long[] {'a', 'z', 'l', 'f'}, new long[] {'z', 'l'}, 0), is(1));
  ...
  public void compare__float() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_FLOATS, Empty.NO_FLOATS, 0));
    assertTrue(PrimitiveFunctions.compare(new float[] {'a'}, new float[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new float[] {'a', 'z'}, new float[] {'a', 'z'}, 0));
    assertFalse(PrimitiveFunctions.compare(new float[] {'a', 'z'}, new float[] {'a', 'y'}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_FLOATS, new float[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new float[] {'a'}, Empty.NO_FLOATS, 0));
  ...
  public void find__float() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_FLOATS, 'a', 0), is(-1));
    assertThat(PrimitiveFunctions.find(new float[] {'a'}, 'a', 0), is(0));
    assertThat(PrimitiveFunctions.find(new float[] {'a', 'z'}, 'z', 0), is(1));
  ...
  public void indexOf__float() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_FLOATS, new float[] {'a'}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new float[] {'a'}, new float[] {'a'}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new float[] {'a', 'z'}, new float[] {'z'}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new float[] {'a', 'z', 'l', 'f'}, new float[] {'z', 'l'}, 0), is(1));
  ...
  public void compare__double() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_DOUBLES, Empty.NO_DOUBLES, 0));
    assertTrue(PrimitiveFunctions.compare(new double[] {'a'}, new double[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new double[] {'a', 'z'}, new double[] {'a', 'z'}, 0));
    assertFalse(PrimitiveFunctions.compare(new double[] {'a', 'z'}, new double[] {'a', 'y'}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_DOUBLES, new double[] {'a'}, 0));
    assertTrue(PrimitiveFunctions.compare(new double[] {'a'}, Empty.NO_DOUBLES, 0));
  ...
  public void find__double() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_DOUBLES, 'a', 0), is(-1));
    assertThat(PrimitiveFunctions.find(new double[] {'a'}, 'a', 0), is(0));
    assertThat(PrimitiveFunctions.find(new double[] {'a', 'z'}, 'z', 0), is(1));
  ...
  public void indexOf__double() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_DOUBLES, new double[] {'a'}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new double[] {'a'}, new double[] {'a'}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new double[] {'a', 'z'}, new double[] {'z'}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new double[] {'a', 'z', 'l', 'f'}, new double[] {'z', 'l'}, 0), is(1));
  ...
  public void compare__boolean() {
    ...
    // compare(char[], char[])
    assertTrue(PrimitiveFunctions.compare(Empty.NO_BOOLEANS, Empty.NO_BOOLEANS, 0));
    assertTrue(PrimitiveFunctions.compare(new boolean[] {false}, new boolean[] {false}, 0));
    assertTrue(PrimitiveFunctions.compare(new boolean[] {false, true}, new boolean[] {false, true}, 0));
    assertFalse(PrimitiveFunctions.compare(new boolean[] {false, true}, new boolean[] {false, false}, 0));
    assertFalse(PrimitiveFunctions.compare(Empty.NO_BOOLEANS, new boolean[] {false}, 0));
    assertTrue(PrimitiveFunctions.compare(new boolean[] {false}, Empty.NO_BOOLEANS, 0));
  ...
  public void find__boolean() {
    ...
    // find(char[], char)
    assertThat(PrimitiveFunctions.find(Empty.NO_BOOLEANS, false, 0), is(-1));
    assertThat(PrimitiveFunctions.find(new boolean[] {false}, false, 0), is(0));
    assertThat(PrimitiveFunctions.find(new boolean[] {false, true}, true, 0), is(1));
  ...
  public void indexOf__boolean() {
    ...
    // indexOf(char[], char)
    assertThat(PrimitiveFunctions.indexOf(Empty.NO_BOOLEANS, new boolean[] {false}, 0), is(-1));
    assertThat(PrimitiveFunctions.indexOf(new boolean[] {false}, new boolean[] {false}, 0), is(0));
    assertThat(PrimitiveFunctions.indexOf(new boolean[] {false, true}, new boolean[] {true}, 0), is(1));
    assertThat(PrimitiveFunctions.indexOf(new boolean[] {false, true, true, true}, new boolean[] {true, true}, 0), is(1));
