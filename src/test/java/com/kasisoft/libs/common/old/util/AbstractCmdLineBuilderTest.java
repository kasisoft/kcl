...
public class AbstractCmdLineBuilderTest {
  ...
  public void flag() {
    ...
    Result   result1 = new ResultBuilder().cfgFlag().parse( args1 );
    assertNotNull( result1 );
    assertFalse( result1.value );
    
    String[] args2   = new String[] { "--value" };
    Result   result2 = new ResultBuilder().cfgFlag().parse( args2 );
    assertNotNull( result2 );
    assertTrue( result2.value );

    String[] args3   = new String[] { "--value", "--value" };
    Result   result3 = new ResultBuilder().cfgFlag().parse( args3 );
    assertNotNull( result3 );
    assertTrue( result3.value );

    String[] args5   = new String[] { "-v" };
    Result   result5 = new ResultBuilder().cfgFlag().parse( args5 );
  ...
  public void string() {
    ...
    String[] args1   = new String[] {};
    Result   result1 = new ResultBuilder().cfgString( false ).parse( args1 );
    assertNotNull( result1 );
    assertNull( result1.stringValue );
    
    String[] args2   = new String[] { "--string" };
    Result   result2 = new ResultBuilder().cfgString( false ).parse( args2 );
    assertNotNull( result2 );
    assertNull( result2.stringValue );

    String[] args3   = new String[] { "--string", "bibo" };
    Result   result3 = new ResultBuilder().cfgString( false ).parse( args3 );
    assertNotNull( result3 );
    assertThat( result3.stringValue, is( "bibo" ) );

    String[] args4   = new String[] { "--string", "bibo", "--string", "dodo" };
    Result   result4 = new ResultBuilder().cfgString( false ).parse( args4 );
    assertNotNull( result4 );
    assertThat( result4.stringValue, is( "bibo" ) );

    String[] args5   = new String[] {};
    Result   result5 = new ResultBuilder().cfgString( true ).parse( args5 );
    assertNull( result5 );
    
    String[] args6   = new String[] { "--string" };
    Result   result6 = new ResultBuilder().cfgString( true ).parse( args6 );
    assertNull( result6 );

    String[] args7   = new String[] { "--string", "bibo" };
    Result   result7 = new ResultBuilder().cfgString( true ).parse( args7 );
    assertNotNull( result7 );
    assertThat( result7.stringValue, is( "bibo" ) );

    String[] args8   = new String[] { "--string", "bibo", "--string", "dodo" };
    Result   result8 = new ResultBuilder().cfgString( true ).parse( args8 );
  ...
  public void path() {
    ...
    String[] args1   = new String[] {};
    Result   result1 = new ResultBuilder().cfgPath( false ).parse( args1 );
    assertNotNull( result1 );
    assertNull( result1.pathValue );
    
    String[] args2   = new String[] { "--path" };
    Result   result2 = new ResultBuilder().cfgPath( false ).parse( args2 );
    assertNotNull( result2 );
    assertNull( result2.pathValue );

    String[] args3   = new String[] { "--path", "/tmp/dodo" };
    Result   result3 = new ResultBuilder().cfgPath( false ).parse( args3 );
    assertNotNull( result3 );
    assertThat( result3.pathValue, is( Paths.get( "/tmp/dodo" ) ) );

    String[] args4   = new String[] { "--path", "/tmp/dodo", "--path", "/tmp/bibo" };
    Result   result4 = new ResultBuilder().cfgPath( false ).parse( args4 );
    assertNotNull( result4 );
    assertThat( result4.pathValue, is( Paths.get( "/tmp/dodo" ) ) );

    String[] args5   = new String[] {};
    Result   result5 = new ResultBuilder().cfgPath( true ).parse( args5 );
    assertNull( result5 );
    
    String[] args6   = new String[] { "--path" };
    Result   result6 = new ResultBuilder().cfgPath( true ).parse( args6 );
    assertNull( result6 );

    String[] args7   = new String[] { "--path", "/tmp/dodo" };
    Result   result7 = new ResultBuilder().cfgPath( true ).parse( args7 );
    assertNotNull( result7 );
    assertThat( result7.pathValue, is( Paths.get( "/tmp/dodo" ) ) );

    String[] args8   = new String[] { "--path", "/tmp/dodo", "--path", "/tmp/bibo" };
    Result   result8 = new ResultBuilder().cfgPath( true ).parse( args8 );
    assertNotNull( result8 );
  ...
  public void strings() {
    ...
    String[] args1   = new String[] {};
    Result   result1 = new ResultBuilder().cfgStrings( false ).parse( args1 );
    assertNotNull( result1 );
    assertNotNull( result1.stringValues );
    assertTrue( result1.stringValues.isEmpty() );
    
    String[] args2   = new String[] { "--strings" };
    Result   result2 = new ResultBuilder().cfgStrings( false ).parse( args2 );
    assertNotNull( result2 );
    assertNotNull( result2.stringValues );
    assertTrue( result1.stringValues.isEmpty() );

    String[] args3   = new String[] { "--strings", "dodo" };
    Result   result3 = new ResultBuilder().cfgStrings( false ).parse( args3 );
    assertNotNull( result3 );
    ...
    Result   result4 = new ResultBuilder().cfgStrings( false ).parse( args4 );
    assertNotNull( result4 );
    ...
    String[] args5   = new String[] {};
    Result   result5 = new ResultBuilder().cfgStrings( true ).parse( args5 );
    assertNull( result5 );
    
    String[] args6   = new String[] { "--strings" };
    Result   result6 = new ResultBuilder().cfgStrings( true ).parse( args6 );
    assertNull( result6 );

    String[] args7   = new String[] { "--strings", "dodo" };
    Result   result7 = new ResultBuilder().cfgStrings( true ).parse( args7 );
    assertNotNull( result7 );
    ...
    Result   result8 = new ResultBuilder().cfgStrings( true ).parse( args8 );
    assertNotNull( result8 );
  ...
  public void paths() {
    ...
    String[] args1   = new String[] {};
    Result   result1 = new ResultBuilder().cfgPaths( false ).parse( args1 );
    assertNotNull( result1 );
    assertNotNull( result1.pathValues );
    assertTrue( result1.pathValues.isEmpty() );
    
    String[] args2   = new String[] { "--paths" };
    Result   result2 = new ResultBuilder().cfgPaths( false ).parse( args2 );
    assertNotNull( result2 );
    assertNotNull( result2.pathValues );
    assertTrue( result1.pathValues.isEmpty() );

    String[] args3   = new String[] { "--paths", "/tmp/dodo" };
    Result   result3 = new ResultBuilder().cfgPaths( false ).parse( args3 );
    assertNotNull( result3 );
    ...
    Result   result4 = new ResultBuilder().cfgPaths( false ).parse( args4 );
    assertNotNull( result4 );
    ...
    String[] args5   = new String[] {};
    Result   result5 = new ResultBuilder().cfgPaths( true ).parse( args5 );
    assertNull( result5 );
    
    String[] args6   = new String[] { "--paths" };
    Result   result6 = new ResultBuilder().cfgPaths( true ).parse( args6 );
    assertNull( result6 );

    String[] args7   = new String[] { "--paths", "/tmp/dodo" };
    Result   result7 = new ResultBuilder().cfgPaths( true ).parse( args7 );
    assertNotNull( result7 );
    ...
    Result   result8 = new ResultBuilder().cfgPaths( true ).parse( args8 );
    assertNotNull( result8 );
  ...
  public void invalidConfiguration() {
    ...
    String[] args1   = new String[] {};
    Result   result1 = new InvalidResultBuilder().cfgFlag().parse( args1 );
    assertNotNull( result1 );
    assertFalse( result1.value );
  ...
  public void defaultValue() {
    ...
    String[] args1   = new String[] {};
    Result   result1 = new DefaultValueResultBuilder().cfgPath( false ).parse( args1 );
    assertNotNull( result1 );
