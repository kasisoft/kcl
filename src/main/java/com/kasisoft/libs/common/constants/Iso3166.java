...
public enum Iso3166 implements Predicate<String> {
    ...
    public boolean test(String langcode) {
        return (langcode != null) && (alpha2.equalsIgnoreCase(langcode) || alpha3.equalsIgnoreCase(langcode));
    }
     ...
     */
    @NotNull
    public static Optional<Iso3166> findByAlpha3(String alpha3) {
     ...
     */
    @NotNull
    public static Optional<Iso3166> findByAlpha2(String alpha2) {
     ...
     */
    @NotNull
    public static Optional<Iso3166> findByNumerical(int numerical) {
        return findBy(LocalData.valuebynum, numerical);
    }

    @NotNull
    private static <K> Optional<Iso3166> findBy(@NotNull Map<K, Iso3166> map, K key) {
        if (key != null) {
