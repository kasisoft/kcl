...
public class GraphicsFunctions {
     ...
     *
     * @param source
     *            The source used to read the data.
     * @param instream
     ...
     *
     * @param outstream
     *            The OutputStream which will receive the content.
     * @param image
     *            The image that has to be written.
     * @param format
     *            The desired output format. Must be a raster format.
     ...
     *            The destination to write to.
     * @param component
     *            The component that has to be written.
     * @param format
     *            The desired output format. Must be a raster format.
     */
     ...
     *
     * @param image
     *            The image that is supposed to be scaled.
     * @param newWidth
     *            The new width. Must be bigger than 0.
     * @param newHeight
     ...
     *
     * @param origin
     *            The image that will be altered in place.
     * @param watermark
     *            The watermark that shall be applied.
     * @param alpha
     *            The alpha level. A range between 0.0 and 1.0 .
     */
     ...
     *            The alpha level. A range between 0.0 and 1.0 .
     * @param padding
     *            Some padding for the watermark within the original image.
     */
     ...
     *            The alpha level. A range between 0.0 and 1.0 .
     * @param alignment
     *            The horizontal/vertical alignment to be chosen.
     */
     ...
     *            The alpha level. A range between 0.0 and 1.0 .
     * @param alignmentX
     *            The horizontal alignment to be chosen.
     * @param alignmentY
     *            The vertical alignment to be chosen.
     */
