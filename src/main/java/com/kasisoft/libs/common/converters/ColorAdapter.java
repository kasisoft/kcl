...
public class ColorAdapter extends AbstractConverter<String, Color> {
    ...
    protected String encodeImpl(@NotNull Color v) {
        return "#%02x%02x%02x%02x".formatted(Integer.valueOf(v.getAlpha()), Integer.valueOf(v.getRed()), Integer.valueOf(v.getGreen()), Integer.valueOf(v.getBlue()));
    }
     ...
     *
     * @param v
     *            A numerical Color representation.
