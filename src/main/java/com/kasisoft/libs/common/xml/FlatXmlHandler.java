...
/**
 * Simple converter which allows to create flat representations of a XML document. This converter
 * simply implements a DefaultHandler used in conjunction with the SAX Parser. An OutputStream must
...
public class FlatXmlHandler extends DefaultHandler {
     ...
     *
     * @param linesep
     *            The new line separator sequence.
     */
     ...
     * @throws SAXException
     *             Writing to the target failed for some reason.
     */
     ...
     *
     * @param input
     *            The input which has to be broken on one line.
