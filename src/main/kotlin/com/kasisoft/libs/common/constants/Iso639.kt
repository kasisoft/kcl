...
enum class Iso639(val bibliography : String, val terminology : String, val alpha2 : String?) : Predicate<String?> {
    ...
    init {
        synchronized(Iso639Cache) {
            Iso639Cache.BIBLIOGRAPHY.put(bibliography, this);
            Iso639Cache.TERMINOLOGY.put(terminology, this);
            Iso639Cache.ALPHA3.put(bibliography, this);
            Iso639Cache.ALPHA3.put(terminology, this);
            if (alpha2 != null) {
                Iso639Cache.ALPHA2.put(alpha2, this);
            }
        }
    }
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun findByBibliography(bibliography : String?) = findBy(Iso639Cache.BIBLIOGRAPHY, bibliography)
         ...
         */
        @JvmStatic
        fun findByTerminology(terminology : String?) = findBy(Iso639Cache.TERMINOLOGY, terminology)
         ...
         */
        @JvmStatic
        fun findByAlpha3(alpha3 : String?) = findBy(Iso639Cache.ALPHA3, alpha3)
         ...
         */
        @JvmStatic
        fun findByAlpha2(alpha2 : String?) = findBy(Iso639Cache.ALPHA2, alpha2)

        private fun findBy(map : Map<String, Iso639>, key : String?) : Iso639? {
            if (key != null) {
                return map.get(key);
            }
            return null;
    ...
    override fun test(code : String?) : Boolean {
        var result = false;
        if(code != null ) {
            result = bibliography.equals(code, true) || terminology.equals(code, true)
            if ((!result) && (alpha2 != null)) {
                result = alpha2.equals(code, true);
            }
        }
        return result;
    }
...
private object Iso639Cache {

    val ALPHA2       = mutableMapOf<String, Iso639>()
    val ALPHA3       = mutableMapOf<String, Iso639>();
    val TERMINOLOGY  = mutableMapOf<String, Iso639>();
    val BIBLIOGRAPHY = mutableMapOf<String, Iso639>();
